  ...
  <body>
    <div id="app" class="min-h-screen pb-16 text-gray-700 bg-gray-50 dark:bg-gray-900 dark:text-white sm:pb-0">
              ...
              <span class="relative">
                <div class="absolute right-0 text-xs font-bold text-blue-500 top-3 text-nowrap">
                  ...
                  <ul class="space-y-2 font-medium">
                      <SideMenuItem :disabled="!loggedIn" tab="bookmarks" name="Bookmarks">
                          <template #icon>
                              <path d="M13 20a1 1 0 0 1-.64-.231L7 15.3l-5.36 4.469A1 1 0 0 1 0 19V2a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v17a1 1 0 0 1-1 1Z"/>
                          </template>
                      </SideMenuItem>

                      <SideMenuItem :disabled="!loggedIn" tab="profile" name="Profile">
                          <template #icon>
                              <path d="M18 0H2a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2ZM6.5 3a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5ZM3.014 13.021l.157-.625A3.427 3.427 0 0 1 6.5 9.571a3.426 3.426 0 0 1 3.322 2.805l.159.622-6.967.023ZM16 12h-3a1 1 0 0 1 0-2h3a1 1 0 0 1 0 2Zm0-3h-3a1 1 0 1 1 0-2h3a1 1 0 1 1 0 2Zm0-3h-3a1 1 0 1 1 0-2h3a1 1 0 1 1 0 2Z"/>
                          </template>
                      </SideMenuItem>

                      <SideMenuItem :disabled="!loggedIn" tab="settings" name="Settings">
                          <template #icon>
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7.75 4H19M7.75 4a2.25 2.25 0 0 1-4.5 0m4.5 0a2.25 2.25 0 0 0-4.5 0M1 4h2.25m13.5 6H19m-2.25 0a2.25 2.25 0 0 1-4.5 0m4.5 0a2.25 2.25 0 0 0-4.5 0M1 10h11.25m-4.5 6H19M7.75 16a2.25 2.25 0 0 1-4.5 0m4.5 0a2.25 2.25 0 0 0-4.5 0M1 16h2.25"/>
                          </template>
                      </SideMenuItem>

                      <SideMenuItem tab="login" :name="loggedIn ? 'Sign Out' : 'Sign In'">
                          <template #icon>
      ...
      <div class="h-full py-6 md:p-6 sm:ml-64">
        ...
        <div v-if="showIf('bookmarks', activeTab)" class="flex flex-col w-full h-full">
          <Bookmarks />
        </div>

        <div v-if="showIf('login', activeTab)" class="flex w-full h-full">
          <Login />
        </div>

        <div v-if="showIf('settings', activeTab)" class="flex w-full h-full">
          <Settings />
        </div>

        <div v-if="showIf('register', activeTab)" class="flex w-full h-full">
          <Registation />
        </div>
      </div>
      ...
      <div class="fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t border-gray-200 sm:hidden dark:bg-gray-700 dark:border-gray-600">
          <div class="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
            ...
            <BottomMenuItem :disabled="!loggedIn" tab="bookmarks" name="Bookmarks">
                <template #icon>
                    <path d="M13 20a1 1 0 0 1-.64-.231L7 15.3l-5.36 4.469A1 1 0 0 1 0 19V2a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v17a1 1 0 0 1-1 1Z"/>
                </template>
            </BottomMenuItem>

            <BottomMenuItem :disabled="!loggedIn" tab="profile" name="Profile">
                <template #icon>
                    <path d="M18 0H2a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2ZM6.5 3a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5ZM3.014 13.021l.157-.625A3.427 3.427 0 0 1 6.5 9.571a3.426 3.426 0 0 1 3.322 2.805l.159.622-6.967.023ZM16 12h-3a1 1 0 0 1 0-2h3a1 1 0 0 1 0 2Zm0-3h-3a1 1 0 1 1 0-2h3a1 1 0 1 1 0 2Zm0-3h-3a1 1 0 1 1 0-2h3a1 1 0 1 1 0 2Z"/>
                </template>
            </BottomMenuItem>

            <BottomMenuItem :disabled="!loggedIn" tab="settings" name="Settings">
                <template #icon>
                  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7.75 4H19M7.75 4a2.25 2.25 0 0 1-4.5 0m4.5 0a2.25 2.25 0 0 0-4.5 0M1 4h2.25m13.5 6H19m-2.25 0a2.25 2.25 0 0 1-4.5 0m4.5 0a2.25 2.25 0 0 0-4.5 0M1 10h11.25m-4.5 6H19M7.75 16a2.25 2.25 0 0 1-4.5 0m4.5 0a2.25 2.25 0 0 0-4.5 0M1 16h2.25"/>
                </template>
            </BottomMenuItem>

            <BottomMenuItem tab="login" :name="loggedIn ? 'Sign Out' : 'Sign In'">
                <template #icon>
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 7.5h11m0 0L8 3.786M12 7.5l-4 3.714M12 1h3c.53 0 1.04.196 1.414.544.375.348.586.82.586 1.313v9.286c0 .492-.21.965-.586 1.313A2.081 2.081 0 0 1 15 14h-3"/>
                </template>
            </BottomMenuItem>
